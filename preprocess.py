...
def process_song(song_path, output_folder, sr=11025, set_type='train'):
    ...
    subfolder_name = 'non_prog_rock' if 'Top_Of_The_Pops' in root or 'Other_Songs' in root else 'prog_rock'
    song_name = os.path.splitext(file)[0]
    
    # Construct the output path
    output_path = os.path.join(output_folder, set_type, subfolder_name, song_name)
