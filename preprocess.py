            ...
            try:
                ...
                if sr_orig != sr:
                    audio_resampled = librosa.resample(
                        audio_trimmed, orig_sr=sr_orig, target_sr=sr
                    )
                else:
                ...
                chunks = [
                    audio_resampled[i : i + chunk_length]
                    for i in range(0, len(audio_resampled), chunk_length)
                ]
...
input_folders = ["data/Not_Progressive_Rock"]
